      ...
      <div className='profile m-20'>
              ...
              <div className='fs-14'>
                <label>
                  <input
                    ...
                    readOnly
                  />
                  <div className='toggle-switch' onClick={toggleCheckbox}></div>
                </label>
              </div>
            </div>
            <div className='info-row p-15 border-b'>
        ...
        <div className='other-data d-flex gap-20'>
          ...
          <div className='activities p-20 mt-20 bg-white rad-10'>
            ...
            <div className='activity-row d-flex mb-15 pb-15 border-b align-c txt-c-mobile'>
              <img src='assets/imgs/activity-01.png' alt='' />
              <div className='info'>
                <span>Store</span>
                <span className='d-block c-gray mt-10'>
                  Bought The Mastring Python Course
                </span>
              </div>
              <div className='date'>
